//
//  UITextFieldShowViewController.m
//  BoolBear
//
//  Created by RuqiangLiu on 2020/5/19.
//  Copyright © 2020 RuqiangLiu. All rights reserved.
//

#import "UITextFieldShowViewController.h"

#define kMaxLength 20

@interface UITextFieldShowViewController ()<UITextFieldDelegate>

@property(nonatomic,strong)UITextField *textField;

@end

@implementation UITextFieldShowViewController
...
- (void)viewDidLoad {
    ...
    _textField.text = @"只能输入中英文";
    _textField.textColor = @"#212121".toColor;
    _textField.layer.borderColor = @"#000000".toColor.CGColor;
